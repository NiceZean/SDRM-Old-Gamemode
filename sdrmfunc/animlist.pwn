...
//------------------------------------------------
forward OnPlayerDeathanim(playerid);
public OnPlayerDeathanim(playerid)
{
...
//-------------------------------------------------
forward OnPlayerSpawnanim(playerid);
public OnPlayerSpawnanim(playerid)
{
...
//-------------------------------------------------
forward OnPlayerConnectanim(playerid);
public OnPlayerConnectanim(playerid)
{
    gPlayerUsingLoopingAnim[playerid] = 0;
...
//-------------------------------------------------
forward OnFilterScriptInitanim();
public OnFilterScriptInitanim()
{
	/*
...
{
	SendClientMessage(playerid, COLOR_GRAD1, "/bodypush /lowbodypush /headbutt /airkick /doorkick /leftslap /elbow /coprun /handsup");
    SendClientMessage(playerid, COLOR_GRAD1, "/piss /sneak /drunk /bomb /rob /laugh /lookout /robman /hide");
    SendClientMessage(playerid, COLOR_GRAD1, "/vomit /eat /slapass /crack /fucku /taichi /drinkwater /checktime /sleep");
    SendClientMessage(playerid, COLOR_GRAD1, "/blob /opendoor /wavedown /cpr /dive /showoff /goggles /cry /throw");
    SendClientMessage(playerid, COLOR_GRAD1, "/robbed /hurt /box /washhands /crabs /salute /jerkoff /stop /rap");
    SendClientMessage(playerid, COLOR_GRAD1, "/chat /gesture /lay /wave /signal /salute /nobreath /fallover /pedmove");
    SendClientMessage(playerid, COLOR_GRAD1, "/getjiggy /stripclub /smoke /dj /reload /tag /deal /crossarms /cheer");
    SendClientMessage(playerid, COLOR_GRAD1, "/sit /siteat /bar /dance /spank /sexy /holdup /copa /misc");
    SendClientMessage(playerid, COLOR_GRAD1, "/snatch /blowjob /kiss /idles /sunbathe /lowrider /carchat");
	SendClientMessage(playerid, COLOR_GREEN, "Use /stopanim to stop an animation.");
	return 1;
}
