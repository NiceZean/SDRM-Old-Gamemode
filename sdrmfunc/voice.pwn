...
forward Onplayerconnectvoice(playerid);
public Onplayerconnectvoice(playerid) 
{
...
forward Onplayerdisconnectvoice(playerid);
public Onplayerdisconnectvoice(playerid) 
{
...
forward OnGameModeInitvoice();
public OnGameModeInitvoice()
{
...
forward OnGameModeExitvoice();
public OnGameModeExitvoice()
{
